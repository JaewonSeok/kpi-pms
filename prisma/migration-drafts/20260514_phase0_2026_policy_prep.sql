-- Phase 0 draft only. Do not apply automatically.
-- Purpose: additive schema support for the 2026 evaluation policy model.
-- This draft preserves existing records and does not switch live scoring or grade calculation.
