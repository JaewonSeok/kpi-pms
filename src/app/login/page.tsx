...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #1e40af 0%, #1d4ed8 50%, #2563eb 100%)' }}>
      <div className="w-full max-w-md mx-4">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="mt-6 text-xs text-gray-400 text-center">
            사내 Google Workspace 계정으로만 접속 가능합니다.<br/>
            계정 문의: HR팀 내선 1234
          </p>
        </div>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-blue-700"><div className="text-white">로딩중...</div></div>}>
      <LoginContent />
    </Suspense>
  )
}
