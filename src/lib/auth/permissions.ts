...
export const MENU_PERMISSIONS: Record<MenuKey, AuthRole[]> = {
  ...
  PERFORMANCE_OPS: ['ROLE_ADMIN', 'ROLE_CEO', 'ROLE_DIV_HEAD', 'ROLE_SECTION_CHIEF', 'ROLE_TEAM_LEADER'],
  AI_COMPETENCY: [
    'ROLE_ADMIN',
    'ROLE_CEO',
    'ROLE_DIV_HEAD',
...
const PATH_MENU_ENTRIES: Array<{ prefix: string; menuKey: MenuKey }> = [
  ...
  { prefix: '/admin/preview-2026-grade', menuKey: 'PREVIEW_2026_GRADE' },
  ...
  { prefix: '/api/evaluation', menuKey: 'PERFORMANCE_EVALUATION' },
  { prefix: '/api/evaluation/ai-competency', menuKey: 'AI_COMPETENCY' },
  { prefix: '/admin/performance-assignments', menuKey: 'EVAL_CYCLE' },
  { prefix: '/api/admin/performance-assignments', menuKey: 'EVAL_CYCLE' },
